...
import aquarius.iemodule.filemanager.InMemoryFile;
import aquarius.iemodule.filemanager.RealFile;
...
public class IEContext {
    ...
    private static IEProperties.FileStoreType storeType;
    ...
    public static IEProperties.FileStoreType getStoreType() {
        return storeType;
    }

    public static IEFile createFile(String filePath) {
        if (storeType == IEProperties.FileStoreType.DISK)
            return new RealFile(filePath);
        return new InMemoryFile(filePath);
    }
